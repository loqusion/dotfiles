...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-under-comparator", "cmp-buffer", "cmp-nvim-lsp-signature-help", "cmp-nvim-lsp-document-symbol", "cmp-cmdline", "cmp-nvim-lua", "cmp-path", "cmp_luasnip" },
  ...
  ["which-key.nvim"] = {
    config = { "\27LJ\2\nï\2\0\0\5\0\n\0\r6\0\0\0'\2\1\0B\0\2\0029\0\2\0005\2\6\0005\3\4\0005\4\3\0=\4\5\3=\3\a\0025\3\b\0=\3\t\2B\0\2\1K\0\1\0\14operators\1\0\t\ag~\16Toggle case\6y\16Yank (copy)\agu\14Lowercase\6c\vChange\agU\14Uppercase\azf\16Create fold\6d\vDelete\6v\26Visual Character Mode\6!#Filter though external program\fplugins\1\0\0\fpresets\1\0\0\1\0\1\14operators\1\nsetup\14which-key\frequire\0" },
    loaded = true,
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'gitsigns.nvim', 'nvim-treesitter', 'vim-matchup'}, { event = "BufRead *" }, _G.packer_plugins)]]
vim.cmd [[au BufNewFile * ++once lua require("packer.load")({'gitsigns.nvim', 'nvim-treesitter', 'vim-matchup'}, { event = "BufNewFile *" }, _G.packer_plugins)]]
