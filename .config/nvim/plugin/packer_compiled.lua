...
_G.packer_plugins = {
  ...
  LuaSnip = {
    after = { "lspkind.nvim", "nvim-cmp", "cmp-under-comparator" },
  ...
  neotest = {
    after = { "neotest-vim-test", "neotest-jest", "neotest-python", "neotest-go" },
  ...
  ["nvim-cmp"] = {
    after = { "cmp-nvim-lsp", "cmp-nvim-lua", "cmp-nvim-lsp-signature-help", "cmp-buffer", "cmp-cmdline", "cmp-nvim-lsp-document-symbol", "cmp-path", "cmp_luasnip", "cmp-npm" },
  ...
  ["nvim-dap"] = {
    after = { "nvim-dap-ui", "nvim-dap-python", "nvim-dap-virtual-text" },
  ...
  ["nvim-lsp-installer"] = {
    after = { "lsp_signature.nvim", "nvim-lightbulb", "lsp-colors.nvim", "fidget.nvim", "vim-illuminate" },
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-treesitter-endwise", "treesitter-unit", "neorg", "spellsitter.nvim", "nvim-treesitter-textsubjects", "nvim-ts-context-commentstring", "nvim-treesitter-context", "detect-language.nvim", "iswap.nvim", "nvim-treesitter-textobjects" },
  ...
  ["telescope.nvim"] = {
    after = { "neorg", "session-lens", "telescope-repo.nvim", "telescope-fzf-native.nvim", "telescope-frecency.nvim", "neorg-telescope", "telescope-dap.nvim", "telescope-ui-select.nvim", "telescope-file-browser.nvim" },
  ...
  ["vim-fugitive"] = {
    after = { "fugitive-gitlab.vim", "vim-rhubarb" },
  ...
  ["which-key.nvim"] = {
    config = { "\27LJ\2\n•\2\0\0\5\0\n\0\r6\0\0\0'\2\1\0B\0\2\0029\0\2\0005\2\6\0005\3\4\0005\4\3\0=\4\5\3=\3\a\0025\3\b\0=\3\t\2B\0\2\1K\0\1\0\14operators\1\0\t\agU\14Uppercase\6v\26Visual Character Mode\6d\vDelete\6c\vChange\azf\16Create fold\6!#Filter though external program\6y\16Yank (copy)\ag~\16Toggle case\agu\14Lowercase\fplugins\1\0\0\fpresets\1\0\0\1\0\1\14operators\1\nsetup\14which-key\frequire\0" },
    loaded = true,
...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'markdown-preview.nvim', 'clipboard-image.nvim', 'nvim-ts-autotag', 'vim-markdown'}, { ft = "markdown" }, _G.packer_plugins)]]
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'vim-asterisk', 'nvim-colorizer.lua', 'vim-textobj-comment', 'gitsigns.nvim', 'git-conflict.nvim', 'nvim-treesitter', 'vim-surround', 'vim-matchup'}, { event = "BufRead *" }, _G.packer_plugins)]]
vim.cmd [[au BufNewFile * ++once lua require("packer.load")({'vim-asterisk', 'nvim-colorizer.lua', 'vim-textobj-comment', 'gitsigns.nvim', 'git-conflict.nvim', 'nvim-treesitter', 'vim-surround', 'vim-matchup'}, { event = "BufNewFile *" }, _G.packer_plugins)]]
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'undotree', 'auto-dark-mode.nvim', 'vim-wordmotion', 'vim-niceblock'}, { event = "VimEnter *" }, _G.packer_plugins)]]
