...
_G.packer_plugins = {
  ...
  LuaSnip = {
    after = { "cmp-under-comparator", "lspkind.nvim", "nvim-cmp" },
  ...
  ["formatter.nvim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/Users/rasnauf/.local/share/nvim/site/pack/packer/opt/formatter.nvim",
  ...
  neotest = {
    after = { "neotest-jest", "neotest-python", "neotest-vim-test", "neotest-go" },
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "cmp-nvim-lsp", "cmp-cmdline", "cmp-nvim-lsp-signature-help", "cmp-nvim-lsp-document-symbol", "cmp-nvim-lua", "cmp-path", "cmp-npm", "cmp_luasnip" },
  ...
  ["nvim-treesitter"] = {
    after = { "treesitter-unit", "nvim-treesitter-textsubjects", "neorg", "nvim-treesitter-textobjects", "spellsitter.nvim", "nvim-ts-context-commentstring", "nvim-treesitter-endwise", "nvim-treesitter-context" },
  ...
  ["telescope.nvim"] = {
    after = { "session-lens", "neorg", "telescope-file-browser.nvim", "telescope-repo.nvim", "telescope-frecency.nvim", "telescope-ui-select.nvim", "telescope-dap.nvim", "telescope-fzf-native.nvim" },
  ...
  ["which-key.nvim"] = {
    config = { "\27LJ\2\n•\2\0\0\5\0\n\0\r6\0\0\0'\2\1\0B\0\2\0029\0\2\0005\2\6\0005\3\4\0005\4\3\0=\4\5\3=\3\a\0025\3\b\0=\3\t\2B\0\2\1K\0\1\0\14operators\1\0\t\agU\14Uppercase\6c\vChange\azf\16Create fold\6!#Filter though external program\ag~\16Toggle case\6y\16Yank (copy)\6d\vDelete\agu\14Lowercase\6v\26Visual Character Mode\fplugins\1\0\0\fpresets\1\0\0\1\0\1\14operators\1\nsetup\14which-key\frequire\0" },
    loaded = true,
...
vim.cmd [[au FileType vimwiki ++once lua require("packer.load")({'markdown-preview.nvim', 'vim-markdown', 'clipboard-image.nvim'}, { ft = "vimwiki" }, _G.packer_plugins)]]
...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'markdown-preview.nvim', 'nvim-ts-autotag', 'vim-markdown', 'clipboard-image.nvim'}, { ft = "markdown" }, _G.packer_plugins)]]
...
vim.cmd [[au BufNewFile * ++once lua require("packer.load")({'nvim-treesitter', 'gitsigns.nvim', 'vim-textobj-comment', 'git-conflict.nvim', 'vim-surround', 'nvim-colorizer.lua', 'vim-matchup'}, { event = "BufNewFile *" }, _G.packer_plugins)]]
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-treesitter', 'gitsigns.nvim', 'vim-textobj-comment', 'git-conflict.nvim', 'vim-surround', 'nvim-colorizer.lua', 'vim-matchup'}, { event = "BufRead *" }, _G.packer_plugins)]]
