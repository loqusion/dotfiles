...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp_luasnip", "cmp-under-comparator", "cmp-nvim-lua", "cmp-nvim-lsp-signature-help", "cmp-nvim-lsp-document-symbol", "cmp-buffer", "cmp-path", "cmp-cmdline" },
  ...
  ["which-key.nvim"] = {
    config = { "\27LJ\2\nï\2\0\0\5\0\n\0\r6\0\0\0'\2\1\0B\0\2\0029\0\2\0005\2\6\0005\3\4\0005\4\3\0=\4\5\3=\3\a\0025\3\b\0=\3\t\2B\0\2\1K\0\1\0\14operators\1\0\t\6y\16Yank (copy)\6c\vChange\ag~\16Toggle case\6!#Filter though external program\agU\14Uppercase\azf\16Create fold\agu\14Lowercase\6v\26Visual Character Mode\6d\vDelete\fplugins\1\0\0\fpresets\1\0\0\1\0\1\14operators\1\nsetup\14which-key\frequire\0" },
    loaded = true,
...
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'vim-niceblock', 'undotree', 'auto-dark-mode.nvim', 'vim-wordmotion'}, { event = "VimEnter *" }, _G.packer_plugins)]]
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'gitsigns.nvim', 'vim-matchup', 'nvim-treesitter'}, { event = "BufRead *" }, _G.packer_plugins)]]
...
vim.cmd [[au BufNewFile * ++once lua require("packer.load")({'gitsigns.nvim', 'vim-matchup', 'nvim-treesitter'}, { event = "BufNewFile *" }, _G.packer_plugins)]]
