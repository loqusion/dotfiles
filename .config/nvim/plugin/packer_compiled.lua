...
_G.packer_plugins = {
  ...
  neotest = {
    after = { "neotest-vim-test", "neotest-jest", "neotest-go", "neotest-python" },
  ...
  ["nvim-cmp"] = {
    after = { "cmp-npm", "cmp-nvim-lsp", "cmp-nvim-lsp-signature-help", "cmp-nvim-lua", "cmp-nvim-lsp-document-symbol", "cmp-buffer", "cmp-cmdline", "cmp-path", "cmp_luasnip" },
  ...
  ["nvim-treesitter"] = {
    after = { "treesitter-unit", "nvim-treesitter-textsubjects", "spellsitter.nvim", "nvim-ts-context-commentstring", "neorg", "nvim-treesitter-context", "iswap.nvim", "nvim-treesitter-textobjects", "nvim-treesitter-endwise" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-frecency.nvim", "telescope-fzf-native.nvim", "telescope-dap.nvim", "telescope-file-browser.nvim", "telescope-repo.nvim", "neorg-telescope", "neorg", "session-lens", "telescope-ui-select.nvim" },
  ...
  ["which-key.nvim"] = {
    config = { "\27LJ\2\n•\2\0\0\5\0\n\0\r6\0\0\0'\2\1\0B\0\2\0029\0\2\0005\2\6\0005\3\4\0005\4\3\0=\4\5\3=\3\a\0025\3\b\0=\3\t\2B\0\2\1K\0\1\0\14operators\1\0\t\azf\16Create fold\ag~\16Toggle case\6y\16Yank (copy)\6!#Filter though external program\6d\vDelete\6v\26Visual Character Mode\6c\vChange\agu\14Lowercase\agU\14Uppercase\fplugins\1\0\0\fpresets\1\0\0\1\0\1\14operators\1\nsetup\14which-key\frequire\0" },
    loaded = true,
...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'nvim-ts-autotag', 'vim-markdown', 'markdown-preview.nvim', 'clipboard-image.nvim'}, { ft = "markdown" }, _G.packer_plugins)]]
...
vim.cmd [[au BufNewFile * ++once lua require("packer.load")({'vim-textobj-comment', 'nvim-treesitter', 'nvim-colorizer.lua', 'gitsigns.nvim', 'git-conflict.nvim', 'vim-matchup', 'vim-asterisk', 'vim-surround'}, { event = "BufNewFile *" }, _G.packer_plugins)]]
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'vim-niceblock', 'vim-wordmotion', 'undotree', 'auto-dark-mode.nvim'}, { event = "VimEnter *" }, _G.packer_plugins)]]
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'LuaSnip', 'vim-arpeggio'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
vim.cmd [[au BufRead * ++once lua require("packer.load")({'vim-textobj-comment', 'nvim-treesitter', 'nvim-colorizer.lua', 'gitsigns.nvim', 'git-conflict.nvim', 'vim-matchup', 'vim-asterisk', 'vim-surround'}, { event = "BufRead *" }, _G.packer_plugins)]]
