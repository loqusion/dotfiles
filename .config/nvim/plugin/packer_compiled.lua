...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp_luasnip", "cmp-npm", "cmp-buffer", "cmp-path", "cmp-cmdline", "cmp-nvim-lua", "cmp-nvim-lsp-document-symbol", "cmp-nvim-lsp", "cmp-nvim-lsp-signature-help" },
  ...
  ["nvim-dap"] = {
    after = { "nvim-dap-python", "nvim-dap-virtual-text", "nvim-dap-ui" },
  ...
  ["nvim-treesitter"] = {
    after = { "spellsitter.nvim", "treesitter-unit", "neorg", "nvim-treesitter-endwise", "nvim-treesitter-textobjects", "nvim-treesitter-textsubjects", "iswap.nvim", "nvim-ts-context-commentstring", "nvim-treesitter-context" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-frecency.nvim", "telescope-fzf-native.nvim", "telescope-ui-select.nvim", "telescope-file-browser.nvim", "neorg", "neorg-telescope", "session-lens", "telescope-repo.nvim", "telescope-dap.nvim" },
  ...
  ["which-key.nvim"] = {
    config = { "\27LJ\2\n•\2\0\0\5\0\n\0\r6\0\0\0'\2\1\0B\0\2\0029\0\2\0005\2\6\0005\3\4\0005\4\3\0=\4\5\3=\3\a\0025\3\b\0=\3\t\2B\0\2\1K\0\1\0\14operators\1\0\t\6c\vChange\azf\16Create fold\6!#Filter though external program\ag~\16Toggle case\6y\16Yank (copy)\6d\vDelete\6v\26Visual Character Mode\agu\14Lowercase\agU\14Uppercase\fplugins\1\0\0\fpresets\1\0\0\1\0\1\14operators\1\nsetup\14which-key\frequire\0" },
    loaded = true,
...
vim.cmd [[au BufNewFile * ++once lua require("packer.load")({'vim-matchup', 'nvim-colorizer.lua', 'git-conflict.nvim', 'nvim-treesitter', 'vim-asterisk', 'vim-textobj-comment', 'vim-surround', 'gitsigns.nvim'}, { event = "BufNewFile *" }, _G.packer_plugins)]]
...
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'undotree', 'vim-wordmotion', 'vim-niceblock', 'auto-dark-mode.nvim'}, { event = "VimEnter *" }, _G.packer_plugins)]]
vim.cmd [[au CmdlineEnter * ++once lua require("packer.load")({'LuaSnip'}, { event = "CmdlineEnter *" }, _G.packer_plugins)]]
vim.cmd [[au BufRead * ++once lua require("packer.load")({'vim-matchup', 'nvim-colorizer.lua', 'git-conflict.nvim', 'nvim-treesitter', 'vim-asterisk', 'vim-textobj-comment', 'vim-surround', 'gitsigns.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
