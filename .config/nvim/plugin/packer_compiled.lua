...
_G.packer_plugins = {
  ...
  neotest = {
    after = { "neotest-vim-test", "neotest-go", "neotest-python", "neotest-jest" },
  ...
  ["nvim-cmp"] = {
    after = { "cmp-nvim-lsp", "cmp-npm", "cmp_luasnip", "cmp-nvim-lua", "cmp-nvim-lsp-signature-help", "cmp-buffer", "cmp-cmdline", "cmp-nvim-lsp-document-symbol", "cmp-path" },
  ...
  ["nvim-lsp-installer"] = {
    after = { "vim-illuminate", "lsp-colors.nvim", "lsp_signature.nvim", "fidget.nvim", "nvim-lightbulb" },
  ...
  ["nvim-treesitter"] = {
    after = { "neorg", "nvim-treesitter-textsubjects", "treesitter-unit", "spellsitter.nvim", "nvim-treesitter-context", "nvim-treesitter-textobjects", "nvim-ts-context-commentstring", "nvim-treesitter-endwise", "detect-language.nvim", "iswap.nvim" },
  ...
  ["telescope.nvim"] = {
    after = { "session-lens", "neorg-telescope", "neorg", "telescope-fzf-native.nvim", "telescope-dap.nvim", "telescope-ui-select.nvim", "telescope-file-browser.nvim", "telescope-repo.nvim", "telescope-frecency.nvim" },
  ...
  ["which-key.nvim"] = {
    config = { "\27LJ\2\n•\2\0\0\5\0\n\0\r6\0\0\0'\2\1\0B\0\2\0029\0\2\0005\2\6\0005\3\4\0005\4\3\0=\4\5\3=\3\a\0025\3\b\0=\3\t\2B\0\2\1K\0\1\0\14operators\1\0\t\6!#Filter though external program\6v\26Visual Character Mode\6c\vChange\ag~\16Toggle case\agu\14Lowercase\agU\14Uppercase\6d\vDelete\azf\16Create fold\6y\16Yank (copy)\fplugins\1\0\0\fpresets\1\0\0\1\0\1\14operators\1\nsetup\14which-key\frequire\0" },
    loaded = true,
...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'nvim-ts-autotag', 'clipboard-image.nvim', 'markdown-preview.nvim'}, { ft = "markdown" }, _G.packer_plugins)]]
...
vim.cmd [[au BufNewFile * ++once lua require("packer.load")({'vim-asterisk', 'gitsigns.nvim', 'git-conflict.nvim', 'nvim-treesitter', 'nvim-colorizer.lua', 'vim-textobj-comment', 'vim-surround', 'vim-matchup'}, { event = "BufNewFile *" }, _G.packer_plugins)]]
...
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'undotree', 'auto-dark-mode.nvim', 'vim-niceblock', 'vim-wordmotion'}, { event = "VimEnter *" }, _G.packer_plugins)]]
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'vim-asterisk', 'gitsigns.nvim', 'git-conflict.nvim', 'nvim-treesitter', 'nvim-colorizer.lua', 'vim-textobj-comment', 'vim-surround', 'vim-matchup'}, { event = "BufRead *" }, _G.packer_plugins)]]
